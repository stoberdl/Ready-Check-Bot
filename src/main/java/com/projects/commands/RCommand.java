...
public class RCommand implements Command {
  ...
  private void showSavedConfigurationMenu(
      SlashCommandInteractionEvent event, List<ReadyCheckManager.SavedReadyCheck> savedChecks) {
  ...
  private List<Member> getValidMembersFromIds(
      SlashCommandInteractionEvent event, List<String> userIds, String initiatorId) {
