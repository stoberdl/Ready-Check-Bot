        ...
        jda.updateCommands()
                .addCommands(
                        ...
                        Commands.slash("ready", "Start a ready check")
                                .addOption(OptionType.STRING, "targets", "Roles and/or users: @GameRole @Alice @Bob", true)
                                .addOption(OptionType.BOOLEAN, "people", "Whether to @mention people in messages (default: true)", false))
